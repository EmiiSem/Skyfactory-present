class Slider {
    ...
    init() {
        ...
        // если кадров два, то ширина каждого кадра будет 100/2 = 50%
        ...
        // 900*2 = 1800 пикселей; но удобнее задать в процентах от родителя,
        // если кадров два, то ширина контейнера кадров будет 100*2 = 200%
    ...
    play() {
        this.paused = setInterval(() => this.next(), 5500);
    }
